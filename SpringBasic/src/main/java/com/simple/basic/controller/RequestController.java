...
//		@RequestParam방식 - 반드시 값을 화면에서 넘겨야 됨
//		required = false 는 값이 없더라도 통과하게 됩니다.
	//defaultValue는 값이 없을 때 기본 값을 지정할 수 있습니다.
//		@RequestMapping(value="/param", method=RequestMethod.POST)
//		public String param(@RequestParam("id") String x , //id를 받아서 x 맵핑
//							@RequestParam("pw") String y, //pw를 받아서 y 맵핑
//							@RequestParam(value = "inter", required = false , defaultValue="" ) ArrayList<String> list) { //inter를 받아서 list 맵핑 
//			
//
//
...
//		}
	...
	@RequestMapping(value="/param", method=RequestMethod.POST)
	public String param(MemberVO vo)  { //inter를 받아서 list 맵핑 
