...
//	}
	...
	public String loginView() { // vo로 맵핑하고 info로 넘긴다.
	...
	public String loginFrom(MemberVO vo, RedirectAttributes ra) { // vo로 맵핑하고 info로 넘긴다.
//id와 pw가 동일하면 로그인성공
		String id = vo.getId();
		String pw = vo.getPw();
		...
		//addFlashAttribute : 리다이렉트된 페이지에서 한 번만 사용할 수 있는 데이터를 모델에 추가할 때 
			return "redirect:/response/login";
			//리다이렉트를 태우겠다 : 다시 컨트롤러를 태우겠다.
		}
